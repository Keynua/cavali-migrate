 ...
 */
const readExcelRows = async (file) => await (0, node_1.default)(Buffer.from(fs.readFileSync(file)));
exports.readExcelRows = readExcelRows;
//# sourceMappingURL=readExcelRows.js.map